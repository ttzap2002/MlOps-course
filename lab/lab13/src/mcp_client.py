...
if __name__ == "__main__":
    ...
    prompt = "What will be weather in London in two weeks?"
    response = asyncio.run(make_llm_request(prompt))
    print("Response:\n", response)
    ...
    prompt = "Tell me what is the current date. Please use appropriate external tool"
    response = asyncio.run(make_llm_request(prompt))
    print("Response:\n", response)

    print()

    prompt = "Tell me what is the current datetime. Please use appropriate external tool"
    response = asyncio.run(make_llm_request(prompt))
    print("Response:\n", response)
